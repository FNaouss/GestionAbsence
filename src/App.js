...
<table class="table-auto m-auto border-collapse border border-slate-400">
  <thead className='bg-blue-950 text-orange-600'>
    <tr>
      <th class="border border-slate-300 ">Début</th>
      <th class="border border-slate-300 ">Fin</th>
      <th class="border border-slate-300 ">Type de séance</th>
      <th class="border border-slate-300 ">Matière</th>
      <th class="border border-slate-300 ">Enseignant</th>
      <th class="border border-slate-300 ">Action</th>
  ...
  <tbody>
    {data.map((item)=>(
      <tr>
      <td class="border border-slate-300">{item.heuredebut}</td>
      <td class="border border-slate-300">{item.heurefin}</td>
      <td class="border border-slate-300">{item.nom_seance}</td>
      <td class="border border-slate-300">{item.nom_matiere}</td>
      <td class="border border-slate-300">{item.nom_ens}</td>
      <td class="border border-slate-300"><button></button></td>
    </tr>
    ))}
